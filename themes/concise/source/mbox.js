...
TNT.a = (function () {
	return {
		...
		b: {
			...
			clientCode: "vision",
			serverHost: "vision.tt.omtrdc.net",
			mboxTimeout: 15000,
			...
			imsOrgId: "F1D665E655F2BE667F000101@AdobeOrg",
...
mboxStandardFetcher.prototype = {
	...
	fetch: function (Mc) {
		...
		document.write('<script src="' + Mc.buildUrl() + '"><\/script>');
	},
	cancel: function () {}
};
...
(function (X) {
	function Qg(Kd, b, Rg, Sg) {
		...
		document.write('<script src="' + Db.join('') + '"><\/script>');
	}
	function Vg(b, Wg) {
		var W = X.W,
		Xg,
